...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete See-Desktop..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), See-Desktop potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare See-Desktop a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a See-Desktop il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a See-Desktop il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a See-Desktop di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [See-Desktop Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep See-Desktop background service", "Mantieni il servizio di See-Desktop in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione See-Desktop, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show See-Desktop", "Visualizza See-Desktop"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a See-Desktop 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a See-Desktop."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di See-Desktop."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password See-Desktop"),
        ...
        ("Exit", "Esci da See-Desktop"),
        ("Open", "Apri See-Desktop"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare See-Desktop e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna See-Desktop Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di See-Desktop come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da See-Desktop"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra See-Desktop è aperta"),
        ...
        ("About See-Desktop", "Info su See-Desktop"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client See-Desktop remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, See-Desktop verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, See-Desktop salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, See-Desktop non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server See-Desktop non include questa funzionalità."),
