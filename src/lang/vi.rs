...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới See-Desk..."),
        ...
        ("install_tip", "Do cơ chế UAC, See-Desk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt See-Desk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho See-Desk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho See-Desk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [See-Desk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep See-Desk background service", "Giữ dịch vụ See-Desk chạy nền"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu See-Desk"),
        ...
        ("scam_text2", "Chỉ sử dụng See-Desk với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ See-Desk mở"),
        ...
        ("floating_window_tip", "Giữ See-Desk trên cùng"),
