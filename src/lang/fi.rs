...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään See-Desktop verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa See-Desktop ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi See-Desktopin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava See-Desktopille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava See-Desktopille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten See-Desktop daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota See-Desktopille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli See-Desktop ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "See-Desktop palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa See-Desktopin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "See-Desktop palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep See-Desktop background service", "Pidä See-Desktopin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista See-Desktopin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show See-Desktop", "Näytä See-Desktop"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista See-Desktop salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "See-Desktop ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä See-Desktop Server Pro versioon {} jatkaaksesi."),
        ...
        ("About See-Desktop", "Tietoa See-Desktopistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-See-Desktop-asiakasversioon {} yhteensopivuuden takaamiseksi"),
