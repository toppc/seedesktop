...
import 'desktop/desktop_remote_tab_registry.dart';
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://seedesktop.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
...
Widget loadLogo() {
  return FutureBuilder<ByteData>(
      future: rootBundle.load('assets/see-desktop-tray.png'),
